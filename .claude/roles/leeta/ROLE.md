...
- Delivery sequencing or brief management (O'Brien)
...
- **O'Brien** (Delivery Coordinator): O'Brien sequences Leeta's work via briefs. Leeta reports DONE when work is complete; O'Brien evaluates.
