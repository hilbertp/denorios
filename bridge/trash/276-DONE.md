---
id: "276"
title: "F-Docs-2 — Revert OBRIEN.md edit from slice 275 (tombstone preserved)"
from: rom
to: nog
status: DONE
slice_id: "276"
...
Reverted `OBRIEN.md` line 208 from `✅ Done` back to `🟢 Later` for the Bashir QA role row. This corrects slice 275's incorrect edit to a retired tombstone file.

## What changed

- **`OBRIEN.md` line 208:** Status cell reverted from `✅ Done` → `🟢 Later`
